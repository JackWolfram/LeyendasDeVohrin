...
public class Jugador {
    ...
    public static final int RESISTENCIA_TOTAL = 300;
    public int resistencia = 300;
    private int recuperacion = 0;
    private final int RECUPERACION_MAXIMA = 250;
    ...
    private void gestionarVelocidadResistencia() {
        if (GestorControles.teclado.corriendo && resistencia > 0) {
            ...
            if (recuperacion == RECUPERACION_MAXIMA && resistencia < 300) {
                resistencia++;
            }
        }
    }
    ...
    private boolean fueraMapa(final int velocidadX, final int velocidadY) {
        ...
        final Rectangle bordesMapa = mapa.obtenerBordes((int) posicionFuturaX, (int) posicionFuturaY, ANCHO_JUGADOR, ALTO_JUGADOR);
    ...
    public void dibujar(Graphics g) {
        ...
        Dibujo.dibujarImagen(g, imagenActual, centroX, centroY);
    }
